...
Public Class Form2
    ...
    Private Sub Reloaded()
        ...
        Dim response As String = client.DownloadString(supplier_api)

        ' Deserialize the JSON response into a list of objects
        Dim data As List(Of Supplier) = JsonConvert.DeserializeObject(Of List(Of Supplier))(response)
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(supplier_api & "?kode=" & txtKode.Text).Result
            ...
            If response.IsSuccessStatusCode Then
                ...
                Finally
                    If (supplier_baru = False) Then
                        ...
                        Dim data As List(Of Supplier) = JsonConvert.DeserializeObject(Of List(Of Supplier))(jsonString)

                        ' Create textboxes dynamically and set their values
                        For Each mydata As Supplier In data
                            txtKode.Text = mydata.kode
                            txtNama.Text = mydata.nama
                            txtTelp.Text = mydata.telp
    ...
    Private Sub TambahData()
        ...
        Dim postData As String = $"kode={kode}&nama={nama}&telp={telp}&alamat={alamat}"
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(supplier_api & "?kode=" & txtKode.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(supplier_api & "?kode=" & txtKode.Text, "DELETE", byteArray)
