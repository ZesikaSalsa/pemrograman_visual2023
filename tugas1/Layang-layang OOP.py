...
class FrmLayang_Layang:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Sisi A:').grid(row=3, column=0,sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Sisi B:').grid(row=4, column=0,sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Sisi C:').grid(row=5, column=0,sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Sisi D:').grid(row=6, column=0,sticky=W, padx=5, pady=5)
        ...
        self.txtSisi_a.grid(row=3, column=1, padx=5, pady=5)
        self.txtSisi_b = Entry(mainFrame) 
        self.txtSisi_b.grid(row=4, column=1, padx=5, pady=5)
        self.txtSisi_c = Entry(mainFrame) 
        self.txtSisi_c.grid(row=5, column=1, padx=5, pady=5)
        self.txtSisi_d = Entry(mainFrame) 
        self.txtSisi_d.grid(row=6, column=1, padx=5, pady=5)
    ...
    def onHitung(self, event=None):
        ...
        layang = layang_layang(diagonal1, diagonal2, sisi_a, sisi_b, sisi_c, sisi_d)
        luas = layang.luas()
        kel = layang.keliling()
...
class layang_layang():
    ...
    def __init__(self, diagonal1, diagonal2, sisi_a, sisi_b, sisi_c, sisi_d):
...
if __name__ == '__main__':
    root = Tk() 
    aplikasi = FrmLayang_Layang(root, "(OOP) Program Luas dan Keliling Layang-Layang")
    root.mainloop()